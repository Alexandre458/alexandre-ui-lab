...
const demos = {
  ...
  "FUND-0008": dynamic(() => import("@/demos/fundamentals/contextual-action-environmental"), { ssr: false, loading: () => <div className="demo-loading" role="status">Carregando demonstração…</div> }),
